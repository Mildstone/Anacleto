...
#define MODULE_NAME	"rfx-axidma"
#define DMA_LENGTH	(4*1024*1024)
#define XDMA_RING_LEN 10
...
#define XDMA_TEST_TRANSFER	_IO(XDMA_IOCTL_BASE, 6)
	...
	struct xdma_dev {
		void * tx_chan;	/* (struct dma_chan *) */
        void * tx_cmp;     /* (struct completion *) callback_param */
		void * rx_chan;	/* (struct dma_chan *) */
        void *  rx_cmp;	    /* (struct completion *) callback_param */
		u32 device_id;
	};
