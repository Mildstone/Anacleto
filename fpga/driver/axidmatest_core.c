...
static int xilinx_axidmatest_probe(struct platform_device *pdev)
{
    ...
    pr_info(" -> dma requesting slave channel ... axidma0 = ");
    ...
    pr_info(" -> dma requesting slave channel ...axidma1 = ");
    ...
    pr_info(" -> dma add slave channel ...axidma1 = ");
...
{
    pr_info("loading Xilinx test dma driver\n");
...
{
    pr_info("removing Xilinx test dma driver\n");
