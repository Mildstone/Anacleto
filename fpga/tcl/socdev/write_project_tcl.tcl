...
proc ls_filesets { } {
  # Summary: list fileset object properties
  # This helper command is used to script help.
  # Argument Usage:
  # proj_name: project name
  # Return Value:
...
proc ls_specified_fileset { proj_dir proj_name filesets } {
  # Summary: write fileset properties and sources
  # This helper command is used to script help.
  # Argument Usage:
  # proj_name: project name
  ...
  foreach l $l_script_data {
   puts "l_script_data -> $l"
  }
...
proc write_header { proj_dir proj_name file } {
 ...
 # GETTING LOCAL FILES: l_local_files
 #
 ...
 # GETTING REMOTE FILES: l_remote_files
 #
...
# this takes a fileset in tcl_obj and writes all files imports in tcl scripts.



proc ls_files { proj_dir proj_name  fileset type } {
  ...
  foreach file [get_files -norecurse -of_objects [get_filesets $fileset]] {
    ...
    set file_object [lindex [get_files -of_objects [get_filesets $fs_name] [list $file]] 0]
    set file_props [list_property $file_object]
    foreach pp $file_props {
     puts " ... $pp = [get_property "$pp" $file_object]"
    }
...
#    puts "IP FILESET FALSE BlockSrcs"
    return false
  }
  ...
  if { $b_found } {
#    puts "IP FILESET TRUE"
    return true
  }
#  puts "IP FILESET FALSE"
  return false
}
