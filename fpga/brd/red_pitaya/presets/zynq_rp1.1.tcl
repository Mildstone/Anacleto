...
proc board_init {} {
  set name red_pitaya_ps

  # create block design
  create_bd_design "${name}_1"
  create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 $name
  set ps7 [get_bd_cells $name]
  ...
  # execute connection to validare design
  connect_bd_net [get_bd_pins $name/FCLK_CLK0] [get_bd_pins $name/M_AXI_GP0_ACLK]
}

proc getPresetInfo {} {
  return [dict create name {rfx_rp} description {rfx_rp}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {rfx_rp} ]
}
