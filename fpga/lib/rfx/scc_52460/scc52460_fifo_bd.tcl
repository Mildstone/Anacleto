...
################################################################
# This is a generated script based on design: scc52460
#
...
proc create_root_design { parentCell } {
  ...
  set store [ create_bd_port -dir O store ]

  # Create instance: CNVST_buf, and set properties
  set CNVST_buf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 CNVST_buf ]
  set_property -dict [ list \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net CNVST_buf_OBUF_DS_P [get_bd_ports CNVST_P] [get_bd_pins CNVST_buf/OBUF_DS_P]
  connect_bd_net -net IBUF_DS_N_1 [get_bd_ports SDAT_N] [get_bd_pins SDAT_buf/IBUF_DS_N]
