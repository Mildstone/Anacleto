...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_scc52460_1.0  "$make_env(builddir)/edit/vivado"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/axi_SCC52460_S00_AXI.vhd]"\
  "[file normalize $make_env(srcdir)/../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/AD7641_serial_slave.vhd]"\
  "[file normalize $make_env(srcdir)/../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/axi_SCC52460.vhd]"\
  "[file normalize $make_env(srcdir)/../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/component.xml]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for axi_SCC52460_S00_AXI.vhd
  set file "$project_env(dir_src)/../../../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/axi_SCC52460_S00_AXI.vhd"
 ...
 # Properties for AD7641_serial_slave.vhd
  set file "$project_env(dir_src)/../../../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/AD7641_serial_slave.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # Properties for axi_SCC52460.vhd
  set file "$project_env(dir_src)/../../../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/src/axi_SCC52460.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # Properties for component.xml
  set file "$project_env(dir_src)/../../../../../../../anacleto_build2/fpga/lib/rfx/scc_52460/ip/vivado/rfx_scc52460_1.0/component.xml"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
