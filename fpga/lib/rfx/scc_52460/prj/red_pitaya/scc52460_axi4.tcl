...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set repo_path_str [list \
  "$make_env(builddir)/../../red-pitaya-notes"\
  "$make_env(builddir)/../../../../../fpga/ip_repo"\
  "$make_env(builddir)/../../../../../fpga/lib/rfx"\
  "$make_env(builddir)/../../../../../fpga/lib/rfx/scc_52460/ip/vivado"\
 ]
 ...
 set obj [get_filesets sources_1]
 set files [list \
  "[file normalize $project_env(dir_src)/scc52460_axi4.srcs/sources_1/bd/scc52460/scc52460.bd]"\
  "[file normalize $project_env(dir_src)/scc52460_axi4.srcs/sources_1/bd/scc52460/hdl/scc52460_wrapper.v]"\
 ]
 ...
 set files [list \
  "[file normalize $project_env(dir_src)/scc52460_axi4.srcs/constrs_1/new/red_pitaya.xdc]"\
 ]
