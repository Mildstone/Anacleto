...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/src/axi_pwmgen.vhd]"\
  "[file normalize $make_env(srcdir)/src/axi_pwmgen_S00_AXI.vhd]"\
  "[file normalize $make_env(srcdir)/src/pwm.vhd]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for axi_pwmgen.vhd
  set file "$project_env(dir_src)/../../src/axi_pwmgen.vhd"
 ...
 # 
 # Properties for axi_pwmgen_S00_AXI.vhd
  set file "$project_env(dir_src)/../../src/axi_pwmgen_S00_AXI.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
