proc getPresetInfo {} {
  return [dict create name {red_pitaya_z7preset} description {red_pitaya_z7preset}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {red_pitaya_z7preset} ]
}
