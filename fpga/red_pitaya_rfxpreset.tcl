proc getPresetInfo {} {
  return [dict create name {red_pitaya_rfxpreset} description {red_pitaya_rfxpreset}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {red_pitaya_rfxpreset} ]
}
