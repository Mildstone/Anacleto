...
proc ::tclapp::socdev::makeutils::my_command1 { args } {
...
eval [list namespace eval ::tclapp::socdev::makeutils::my_command1 {
} ]

proc ::tclapp::socdev::makeutils::my_command1::lshift {inputlist} {
  # Summary :
  # Argument Usage:
  # Return Value:
  # Categories:
...
proc ::tclapp::socdev::makeutils::my_command1::my_command1 {args} {
  # Summary :
  # Argument Usage:
  # Return Value:
  # Categories:
  ...
  Example:
     tclapp::socdev::makeutils::my_command1
     tclapp::socdev::makeutils::my_command1 -cell ila_v2_1_0 -return_string
} ]
      # HELP -->
      return {}
    }
