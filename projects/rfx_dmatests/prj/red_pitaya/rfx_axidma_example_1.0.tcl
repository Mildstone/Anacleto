...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_axidma_example_1.0  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/src/system.bd]"\
  "[file normalize $make_env(srcdir)/src/hdl/system_wrapper.v]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for system.bd
  set file "$project_env(dir_src)/../../src/system.bd"
 ...
 # Properties for system_wrapper.v
  set file "$project_env(dir_src)/../../src/hdl/system_wrapper.v"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
