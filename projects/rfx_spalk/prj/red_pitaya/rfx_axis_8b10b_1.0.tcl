...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_axis_8b10b_1.0  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/8b10b_encdec/8b10_dec.vhd]"\
  "[file normalize $make_env(srcdir)/8b10b_encdec/8b10_enc.vhd]"\
  "[file normalize $make_env(srcdir)/8b10b_encdec/8b10b_IO.vhd]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for 8b10_dec.vhd
  set file "$project_env(dir_src)/../../8b10b_encdec/8b10_dec.vhd"
 ...
 # 
 # Properties for 8b10_enc.vhd
  set file "$project_env(dir_src)/../../8b10b_encdec/8b10_enc.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
  ...
  set_property -quiet "used_in_synthesis" "1" $file_obj
 # 
 # Properties for 8b10b_IO.vhd
  set file "$project_env(dir_src)/../../8b10b_encdec/8b10b_IO.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
