...
#
# p1_w7x.tcl: Tcl script for re-creating project 'red_pitaya'
#
# Generated by Vivado on Mon Jan 23 14:51:48 CET 2017
...
#
# 1. This project restoration tcl script (p1_w7x.tcl) that was generated.
#
...
#    /git/linux-socdev/projects/w7x_timing/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0/system_w7x_timing_0_0.upgrade_log
#    /git/linux-socdev/projects/w7x_timing/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0_2/system_w7x_timing_0_0.upgrade_log
#    /git/linux-socdev/projects/w7x_timing/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0_3/system_w7x_timing_0_0.upgrade_log
#
...
# Create project
create_project red_pitaya ./red_pitaya -part xc7z010clg400-1
...
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/red_pitaya.cache/compile_simlib/vcs" $obj
...
set files [list \
 ...
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0/system_w7x_timing_0_0.upgrade_log"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0_2/system_w7x_timing_0_0.upgrade_log"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/ip/system_w7x_timing_0_0_3/system_w7x_timing_0_0.upgrade_log"]"\
]
...
set file "system_w7x_timing_0_0/system_w7x_timing_0_0.upgrade_log"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "system_w7x_timing_0_0_2/system_w7x_timing_0_0.upgrade_log"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "IP Update Log" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "system_w7x_timing_0_0_3/system_w7x_timing_0_0.upgrade_log"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "IP Update Log" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
if {[string equal [get_runs -quiet auto_synth_1] ""]} {
  create_run -name auto_synth_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2015} -strategy "Flow_PerfOptimized_high" -constrset constrs_1
} else {
  set_property strategy "Flow_PerfOptimized_high" [get_runs auto_synth_1]
...
set_property "name" "auto_synth_1" $obj
...
if {[string equal [get_runs -quiet auto_impl_1] ""]} {
  create_run -name auto_impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2015} -strategy "Performance_Retiming" -constrset constrs_1 -parent_run auto_synth_1
} else {
  set_property strategy "Performance_Retiming" [get_runs auto_impl_1]
...
set_property "name" "auto_impl_1" $obj
set_property "needs_refresh" "0" $obj
set_property "part" "xc7z010clg400-1" $obj
set_property "srcset" "sources_1" $obj
