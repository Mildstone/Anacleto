...
set_property PULLDOWN true [get_ports state_leds]
...
set_property DRIVE 8 [get_ports state_leds]
...
set_property PACKAGE_PIN K14 [get_ports gate_led]
set_property PACKAGE_PIN G14 [get_ports sig_led]
...
set_output_delay -clock [get_clocks clk] -min -add_delay 10.000 [get_ports state_leds]
set_output_delay -clock [get_clocks clk] -max -add_delay 100.000 [get_ports state_leds]
