...
proc create_root_design { parentCell } {
  ...
  set state_leds [ create_bd_port -dir O -from 3 -to 0 state_leds ]
...
CONFIG.S00_HAS_REGSLICE {3} \
  ...
  connect_bd_net -net w7x_timing_0_leds [get_bd_ports state_leds] [get_bd_pins w7x_timing_0/leds]
  connect_bd_net -net w7x_timing_0_sig [get_bd_ports sig] [get_bd_ports sig_led] [get_bd_pins w7x_timing_0/sig]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs w7x_timing_0/S00_AXI/S00_AXI_reg] SEG_w7x_timing_0_S00_AXI_reg
