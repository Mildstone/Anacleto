FUN PUBLIC RPProg(optional in _delay, optional in _width, optional in _period, optional in _times, optional in _cycle, optional in _repeat, optional in _burst){
...
/* make sequence */
    ...
    return(w7x_timing_lib->makeSequence(ref(_delay),ref(_width),ref(_period),ref(_cycle),ref(_burst),ref(_repeat),ref(_count),ref(_times)));
  } ELSE {
/* make clock */
    _burst = IF_ERROR(KIND(_times)>0,0BU) ? LONG_UNSIGNED(_times) : *;
