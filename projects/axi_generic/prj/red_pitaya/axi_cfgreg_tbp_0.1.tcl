...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project axi_cfgreg_tbp_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp"
 file copy -force "$project_env(dir_src)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/cfgreg_tbp.bd" \
    "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/cfgreg_tbp.bd"
 file mkdir "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/hdl"
 file copy -force "$project_env(dir_src)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/hdl/cfgreg_tbp_wrapper.v" \
    "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/hdl/cfgreg_tbp_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/cfgreg_tbp.bd]"\
  "[file normalize $project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/hdl/cfgreg_tbp_wrapper.v]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for sources_1
 # Properties for cfgreg_tbp.bd
  set file "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/cfgreg_tbp.bd"
 ...
 # 
 # Properties for cfgreg_tbp_wrapper.v
  set file "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/sources_1/bd/cfgreg_tbp/hdl/cfgreg_tbp_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 file mkdir "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/constrs_1/new"
 file copy -force "$project_env(dir_src)/axi_cfgreg_tbp_0.1.srcs/constrs_1/new/redpt.xdc" \
    "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/constrs_1/new/redpt.xdc"
 set files [list \
  "[file normalize $project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/constrs_1/new/redpt.xdc]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for constrs_1
 # Properties for redpt.xdc
  set file "$project_env(dir_prj)/axi_cfgreg_tbp_0.1.srcs/constrs_1/new/redpt.xdc"
