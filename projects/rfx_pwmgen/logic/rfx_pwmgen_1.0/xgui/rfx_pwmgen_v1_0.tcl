...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "sys_clk"
...
proc update_MODELPARAM_VALUE.blink_bit { MODELPARAM_VALUE.blink_bit } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "blink_bit". Setting updated value from the model parameter.
set_property value 20 ${MODELPARAM_VALUE.blink_bit}
}
