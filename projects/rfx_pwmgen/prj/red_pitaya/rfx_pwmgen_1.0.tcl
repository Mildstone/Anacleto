...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_pwmgen_1.0.srcs/constrs_1/new"
 file copy -force "$project_env(dir_src)/rfx_pwmgen_1.0.srcs/constrs_1/new/rp_test.xdc" \
    "$project_env(dir_prj)/rfx_pwmgen_1.0.srcs/constrs_1/new/rp_test.xdc"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_pwmgen_1.0.srcs/constrs_1/new/rp_test.xdc]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for constrs_1
 # Properties for rp_test.xdc
  set file "$project_env(dir_prj)/rfx_pwmgen_1.0.srcs/constrs_1/new/rp_test.xdc"
