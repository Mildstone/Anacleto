...
{    
    if(!file->private_data) {
        ...
        privateInfo->iomap_time = devm_ioremap(&privateInfo->pdev->dev,
                                               red_pitaya_ps_1_axi_fifo_mm_s_1_0[0],
                red_pitaya_ps_1_axi_fifo_mm_s_1_0[1]-red_pitaya_ps_1_axi_fifo_mm_s_1_0[0]);
        ...
        privateInfo->iomap1_time = devm_ioremap(&privateInfo->pdev->dev,
                                                red_pitaya_ps_1_axi_fifo_mm_s_1_0[2],
                red_pitaya_ps_1_axi_fifo_mm_s_1_0[3]-red_pitaya_ps_1_axi_fifo_mm_s_1_0[2]);
        ...
        privateInfo->iomap_cmd_reg = devm_ioremap(&privateInfo->pdev->dev,
                                                  red_pitaya_ps_1_command_register_0[0],
                red_pitaya_ps_1_command_register_0[1]-red_pitaya_ps_1_command_register_0[0]);
        ...
        privateInfo->iomap_pre_post_reg = devm_ioremap(&privateInfo->pdev->dev,
                                                       red_pitaya_ps_1_pre_post_register_0[0],
                red_pitaya_ps_1_pre_post_register_0[1]-red_pitaya_ps_1_pre_post_register_0[0]);
        ...
        privateInfo->iomap_dec_reg = devm_ioremap(&privateInfo->pdev->dev,
                                                  red_pitaya_ps_1_decimator_register_0[0],
                red_pitaya_ps_1_decimator_register_0[1]-red_pitaya_ps_1_decimator_register_0[0]);
        ...
        privateInfo->iomap_mode_reg = devm_ioremap(&privateInfo->pdev->dev,
                                                   red_pitaya_ps_1_mode_register_0[0],
                red_pitaya_ps_1_mode_register_0[1]-red_pitaya_ps_1_mode_register_0[0]);
