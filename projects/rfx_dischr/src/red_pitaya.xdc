...
### LED PINS
set_property PACKAGE_PIN F16 [get_ports {led_o_V[0]}]
set_property PULLDOWN true [get_ports {led_o_V[0]}]
set_property PACKAGE_PIN F17 [get_ports ap_ready]
set_property PULLDOWN true [get_ports ap_ready]
set_property PACKAGE_PIN G15 [get_ports ap_done]
set_property PULLDOWN true [get_ports ap_done]
set_property PACKAGE_PIN H15 [get_ports ap_idle]
set_property PULLDOWN true [get_ports ap_idle]
set_property PACKAGE_PIN K14 [get_ports {led_o2_V[0]}]
set_property PULLDOWN true [get_ports {led_o2_V[0]}]
set_property PACKAGE_PIN G14 [get_ports {start}]
set_property PULLDOWN true [get_ports {start}]

# set_property PACKAGE_PIN J15     [get_ports {led_o_V[6]}]
# set_property PACKAGE_PIN J14     [get_ports {led_o_V[7]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {led_o_V[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_o2_V[0]}]
