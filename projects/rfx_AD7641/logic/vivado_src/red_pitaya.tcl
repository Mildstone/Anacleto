...
#
# Generated by Vivado on Mon Mar 27 13:13:16 UTC 2017
...
#
#    /home/andrea/devel/rfx/linux-socdev-build/projects/rfx_AD7641/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/system.bd
#    /home/andrea/devel/rfx/linux-socdev-build/projects/rfx_AD7641/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/hdl/system_wrapper.vhd
#    /home/andrea/devel/rfx/linux-socdev-build/projects/rfx_AD7641/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/ip/system_prescaler_clock_0_0/system_prescaler_clock_0_0.upgrade_log
#    /home/andrea/devel/rfx/linux-socdev-build/projects/rfx_AD7641/logic/vivado_project/red_pitaya.srcs/component.xml
#    /home/andrea/devel/rfx/linux-socdev-build/projects/rfx_AD7641/logic/vivado_project/red_pitaya.srcs/sources_1/bd/system/ip/system_prescaler_clock_0_1/system_prescaler_clock_0_1.upgrade_log
#
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../prescaler_clock_1.0"] [file normalize "$origin_dir/../../../../fpga/ip_repo/rfx_pwmgen_1.0"]" $obj
...
set files [list \
 ...
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/hdl/system_wrapper.vhd"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/ip/system_prescaler_clock_0_0/system_prescaler_clock_0_0.upgrade_log"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/component.xml"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/system/ip/system_prescaler_clock_0_1/system_prescaler_clock_0_1.upgrade_log"]"\
]
...
set file "system_prescaler_clock_0_0/system_prescaler_clock_0_0.upgrade_log"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "IP Update Log" $file_obj

set file "red_pitaya.srcs/component.xml"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "IP-XACT" $file_obj

set file "system_prescaler_clock_0_1/system_prescaler_clock_0_1.upgrade_log"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "IP Update Log" $file_obj
