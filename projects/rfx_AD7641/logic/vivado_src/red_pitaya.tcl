...
#
# Generated by Vivado on Wed Dec 07 13:16:00 UTC 2016
...
set files [list \
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
 "[file normalize "$make_env(srcdir)/vivado_src/${make_env(project_name)}.srcs/sources_1/bd/design_1/ip/design_1_prescaler_clock_0_0/design_1_prescaler_clock_0_0.upgrade_log"]"\
]
