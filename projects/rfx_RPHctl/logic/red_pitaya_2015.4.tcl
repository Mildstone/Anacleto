...
CONFIG.FREQ_HZ {125000000} \
  ...
  set pwm_led_o [ create_bd_port -dir O pwm_led_o ]
  set pwm_out [ create_bd_port -dir O -from 1 -to 0 pwm_out ]
  set pwm_out_1 [ create_bd_port -dir O -from 1 -to 0 pwm_out_1 ]
...
CONFIG.pwm_freq {10} \
  ...
  connect_bd_intf_net -intf_net processing_system7_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_axi_periph/M00_AXI] [get_bd_intf_pins rfx_pwmgen_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_axi_periph/M01_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins proc_sys_reset/interconnect_aresetn] [get_bd_pins processing_system7_axi_periph/ARESETN]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_axi_periph/S00_ARESETN] [get_bd_pins rfx_pwmgen_0/reset_n] [get_bd_pins rfx_pwmgen_0/s00_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_ports FCLK_CLK3] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK3] [get_bd_pins processing_system7/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_axi_periph/ACLK] [get_bd_pins processing_system7_axi_periph/M00_ACLK] [get_bd_pins processing_system7_axi_periph/M01_ACLK] [get_bd_pins processing_system7_axi_periph/S00_ACLK] [get_bd_pins rfx_pwmgen_0/clk] [get_bd_pins rfx_pwmgen_0/s00_axi_aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rfx_pwmgen_0_led_o [get_bd_ports pwm_led_o] [get_bd_pins rfx_pwmgen_0/led_o]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x83C00000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs rfx_pwmgen_0/S00_AXI/S00_AXI_reg] SEG_rfx_pwmgen_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x83C10000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] SEG_xadc_wiz_0_Reg
...
preplace port S_AXI_HP1 -pg 1 -y 510 -defaultsOSRD
preplace port DDR -pg 1 -y 380 -defaultsOSRD
preplace port M_AXI_GP0_ACLK -pg 1 -y 530 -defaultsOSRD
preplace port FCLK_RESET0_N -pg 1 -y 620 -defaultsOSRD
preplace port S_AXI_HP0_aclk -pg 1 -y 570 -defaultsOSRD
preplace port M_AXI_GP0 -pg 1 -y 440 -defaultsOSRD
preplace port FCLK_RESET1_N -pg 1 -y 640 -defaultsOSRD
preplace port S_AXI_HP1_aclk -pg 1 -y 590 -defaultsOSRD
...
preplace port pwm_led_o -pg 1 -y 950 -defaultsOSRD
preplace port FCLK_CLK2 -pg 1 -y 580 -defaultsOSRD
preplace port S_AXI_HP0 -pg 1 -y 490 -defaultsOSRD
preplace portBus pwm_out_1 -pg 1 -y 930 -defaultsOSRD
preplace portBus pwm_out -pg 1 -y 910 -defaultsOSRD
preplace inst xlconstant -pg 1 -lvl 1 -y 820 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 4 -y 170 -defaultsOSRD
preplace inst processing_system7 -pg 1 -lvl 4 -y 530 -defaultsOSRD
preplace inst processing_system7_axi_periph -pg 1 -lvl 3 -y 900 -defaultsOSRD
preplace inst rfx_pwmgen_0 -pg 1 -lvl 4 -y 930 -defaultsOSRD
preplace inst proc_sys_reset -pg 1 -lvl 2 -y 820 -defaultsOSRD
preplace netloc processing_system7_0_ddr 1 4 1 NJ
preplace netloc processing_system7_0_fclk_reset3_n 1 1 4 170 730 NJ 730 NJ 740 1320
preplace netloc s_axi_hp0_1 1 0 4 NJ 490 NJ 490 NJ 490 NJ
...
preplace netloc s_axi_hp0_aclk 1 0 4 NJ 570 NJ 570 NJ 570 NJ
preplace netloc s_axi_hp1_1 1 0 4 NJ 510 NJ 510 NJ 510 NJ
preplace netloc processing_system7_axi_periph_M01_AXI 1 3 1 840
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 2 1 520
preplace netloc rfx_pwmgen_0_pwm_out 1 4 1 1320
preplace netloc rfx_pwmgen_0_led_o 1 4 1 NJ
preplace netloc s_axi_hp1_aclk 1 0 4 NJ 590 NJ 590 NJ 590 NJ
preplace netloc processing_system7_0_fclk_reset0_n 1 4 1 NJ
preplace netloc processing_system7_axi_periph_M00_AXI 1 3 1 N
preplace netloc processing_system7_M_AXI_GP1 1 2 3 540 750 NJ 750 1310
preplace netloc processing_system7_0_fixed_io 1 4 1 NJ
preplace netloc processing_system7_0_fclk_clk0 1 4 1 NJ
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 2 510 740 850
preplace netloc processing_system7_0_fclk_clk1 1 4 1 NJ
preplace netloc m_axi_gp0_aclk_1 1 0 4 NJ 530 NJ 530 NJ 530 NJ
preplace netloc processing_system7_0_fclk_clk2 1 4 1 NJ
preplace netloc processing_system7_0_fclk_clk3 1 1 4 160 720 530 760 870 730 1330
levelinfo -pg 1 0 90 340 690 1090 1350 -top 0 -bot 1040
",
}
