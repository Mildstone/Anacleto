...
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_led_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_led_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_n_out[1]}]
...
set_property SLEW FAST [get_ports {pwm_led_o[1]}]
set_property SLEW FAST [get_ports {pwm_led_o[0]}]
set_property SLEW FAST [get_ports {pwm_n_out[1]}]
set_property SLEW FAST [get_ports {pwm_n_out[0]}]
set_property SLEW FAST [get_ports {pwm_out[1]}]
set_property SLEW FAST [get_ports {pwm_out[0]}]
set_property PULLDOWN true [get_ports {pwm_led_o[1]}]
set_property PULLDOWN true [get_ports {pwm_led_o[0]}]
set_property PULLDOWN true [get_ports {pwm_n_out[1]}]
set_property PULLDOWN true [get_ports {pwm_n_out[0]}]
set_property PULLDOWN true [get_ports {pwm_out[1]}]
set_property PULLDOWN true [get_ports {pwm_out[0]}]


set_property IOSTANDARD LVCMOS33 [get_ports hk_led_o]
set_property IOSTANDARD LVCMOS33 [get_ports pwm_led_e]
set_property PULLDOWN true [get_ports pwm_led_e]
set_property PACKAGE_PIN G17 [get_ports {pwm_out[1]}]
set_property PACKAGE_PIN G18 [get_ports {pwm_out[0]}]
set_property PACKAGE_PIN H16 [get_ports {pwm_n_out[1]}]
set_property PACKAGE_PIN H17 [get_ports {pwm_n_out[0]}]
set_property PACKAGE_PIN F16 [get_ports pwm_led_e]
set_property PACKAGE_PIN G14 [get_ports hk_led_o]
set_property PACKAGE_PIN F17 [get_ports {pwm_led_o[1]}]
set_property PACKAGE_PIN G15 [get_ports {pwm_led_o[0]}]
