...
################################################################
# This is a generated script based on design: spdgaus_1
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_decimation_register, and set properties
  set axi_decimation_register [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_cfg_register:1.0 axi_decimation_register ]
  set_property -dict [ list \
   CONFIG.AXI_ADDR_WIDTH {4} \
   CONFIG.CFG_DATA_WIDTH {32} \
 ] $axi_decimation_register
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_decimation_register/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins axi_decimation_register/cfg_data] [get_bd_pins axis_decimator_0/cfg_data] [get_bd_pins xlslice_0/Din]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_decimation_register/s_axi/reg0] SEG_axi_cfg_register_0_reg0
