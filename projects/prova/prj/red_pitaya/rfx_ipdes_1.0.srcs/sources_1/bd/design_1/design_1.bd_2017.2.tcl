...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_ports S_AXI] [get_bd_intf_pins axi_cfg_register_0/S_AXI]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins axi_cfg_register_0/aclk] [get_bd_pins pwm_0/clk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins axi_cfg_register_0/aresetn] [get_bd_pins pwm_0/reset_n]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins axi_cfg_register_0/cfg_data] [get_bd_pins pwm_0/duty]
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces S_AXI] [get_bd_addr_segs axi_cfg_register_0/s_axi/reg0] SEG_axi_cfg_register_0_reg0
