...
CONFIG.CONST_WIDTH {8} \
  ...
  connect_bd_net -net red_pitaya_ps_FCLK_CLK0 [get_bd_pins pwm_0/clk] [get_bd_pins red_pitaya_ps/FCLK_CLK0] [get_bd_pins red_pitaya_ps/M_AXI_GP0_ACLK]
  connect_bd_net -net red_pitaya_ps_FCLK_RESET0_N [get_bd_pins pwm_0/reset_n] [get_bd_pins red_pitaya_ps/FCLK_RESET0_N]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins pwm_0/ena] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins pwm_0/duty] [get_bd_pins xlconstant_1/dout]
