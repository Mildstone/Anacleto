...
proc create_root_design { parentCell } {
  ...
  # Create instance: ipdes_0, and set properties
  set ipdes_0 [ create_bd_cell -type ip -vlnv rfx:rfx:ipdes:1.0 ipdes_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /ipdes_0/S_AXI]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net red_pitaya_ps_axi_periph_M00_AXI [get_bd_intf_pins ipdes_0/S_AXI] [get_bd_intf_pins red_pitaya_ps_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net ipdes_0_pwm_n_out [get_bd_ports pwm_n_out] [get_bd_pins ipdes_0/pwm_n_out]
  connect_bd_net -net ipdes_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins ipdes_0/pwm_out]
  connect_bd_net -net red_pitaya_ps_FCLK_CLK0 [get_bd_pins ipdes_0/aclk] [get_bd_pins red_pitaya_ps/FCLK_CLK0] [get_bd_pins red_pitaya_ps/M_AXI_GP0_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/ACLK] [get_bd_pins red_pitaya_ps_axi_periph/M00_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/S00_ACLK] [get_bd_pins rst_red_pitaya_ps_125M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_red_pitaya_ps_125M_peripheral_aresetn [get_bd_pins ipdes_0/aresetn] [get_bd_pins red_pitaya_ps_axi_periph/M00_ARESETN] [get_bd_pins red_pitaya_ps_axi_periph/S00_ARESETN] [get_bd_pins rst_red_pitaya_ps_125M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins ipdes_0/ena] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces red_pitaya_ps/Data] [get_bd_addr_segs ipdes_0/S_AXI/reg0] SEG_ipdes_0_reg0
