...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /example_0/s_axi_BUS_A]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net red_pitaya_ps_axi_periph_M00_AXI [get_bd_intf_pins example_0/s_axi_BUS_A] [get_bd_intf_pins red_pitaya_ps_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net example_0_interrupt [get_bd_pins example_0/interrupt] [get_bd_pins red_pitaya_ps/IRQ_F2P]
  connect_bd_net -net red_pitaya_ps_FCLK_CLK0 [get_bd_pins example_0/ap_clk] [get_bd_pins red_pitaya_ps/FCLK_CLK0] [get_bd_pins red_pitaya_ps/M_AXI_GP0_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/ACLK] [get_bd_pins red_pitaya_ps_axi_periph/M00_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/S00_ACLK] [get_bd_pins rst_red_pitaya_ps_125M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_red_pitaya_ps_125M_peripheral_aresetn [get_bd_pins example_0/ap_rst_n] [get_bd_pins red_pitaya_ps_axi_periph/M00_ARESETN] [get_bd_pins red_pitaya_ps_axi_periph/S00_ARESETN] [get_bd_pins rst_red_pitaya_ps_125M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces red_pitaya_ps/Data] [get_bd_addr_segs example_0/s_axi_BUS_A/Reg] SEG_example_0_Reg
