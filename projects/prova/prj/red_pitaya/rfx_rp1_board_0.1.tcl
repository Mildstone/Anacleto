...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_rp1_board_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board"
 file copy -force "$project_env(dir_src)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/rp1_board.bd" \
    "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/rp1_board.bd"
 file mkdir "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/hdl"
 file copy -force "$project_env(dir_src)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/hdl/rp1_board_wrapper.v" \
    "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/hdl/rp1_board_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/rp1_board.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/hdl/rp1_board_wrapper.v]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for sources_1
 # Properties for rp1_board.bd
  set file "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/rp1_board.bd"
  ...
  set_property -quiet "pfm_name" "vendor:lib:rp1:1.0" $file_obj
  if { ![get_property "is_locked" $file_obj] } {
 ...
 # 
 # Properties for rp1_board_wrapper.v
  set file "$project_env(dir_prj)/rfx_rp1_board_0.1.srcs/sources_1/bd/rp1_board/hdl/rp1_board_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
