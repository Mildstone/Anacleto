...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set duty [ create_bd_port -dir I -from 7 -to 0 duty ]
...
CONFIG.PCW_USE_FABRIC_INTERRUPT {1} \
  ...
  connect_bd_net -net duty_1 [get_bd_ports duty] [get_bd_pins pwm_0/duty]
  connect_bd_net -net ena_1 [get_bd_ports ena] [get_bd_pins pwm_0/ena]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pwm_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins pwm_0/reset_n]
