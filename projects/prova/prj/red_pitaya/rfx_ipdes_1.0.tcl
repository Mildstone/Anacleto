...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_ipdes_1.0  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1"
 file copy -force "$project_env(dir_src)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/design_1.bd" \
    "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/design_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/design_1.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v]"\
  "[file normalize $make_env(srcdir)/../../build/projects/prova/ip/vivado/rfx_ipdes_1.0/component.xml]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for component.xml
  set file "$project_env(dir_src)/../../../../build/projects/prova/ip/vivado/rfx_ipdes_1.0/component.xml"
 ...
 # Properties for design_1.bd
  set file "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/design_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # Properties for design_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_ipdes_1.0.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
