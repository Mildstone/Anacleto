...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1"
 file copy -force "$project_env(dir_src)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/design_1.bd" \
    "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/design_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/design_1.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for sources_1
 # Properties for design_1.bd
  set file "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/design_1.bd"
 ...
 # Properties for design_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_example_test_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
