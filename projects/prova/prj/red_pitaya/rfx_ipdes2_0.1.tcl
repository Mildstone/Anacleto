...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_ipdes2_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1"
 file copy -force "$project_env(dir_src)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/design_1.bd" \
    "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/design_1.bd"
 file mkdir "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/hdl"
 file copy -force "$project_env(dir_src)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/design_1.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v]"\
  "[file normalize $make_env(srcdir)/../../build/projects/prova/ip/vivado/rfx_ipdes2_0.1/component.xml]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for component.xml
  set file "$project_env(dir_src)/../../../../build/projects/prova/ip/vivado/rfx_ipdes2_0.1/component.xml"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "Unknown" $file_obj
 ...
 # Properties for design_1.bd
  set file "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/design_1.bd"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
 ...
 # Properties for design_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_ipdes2_0.1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
