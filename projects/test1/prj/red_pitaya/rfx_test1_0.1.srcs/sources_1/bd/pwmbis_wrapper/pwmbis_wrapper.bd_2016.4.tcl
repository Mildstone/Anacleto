...
################################################################
# This is a generated script based on design: pwmbis_wrapper
#
...
# source pwmbis_wrapper_script.tcl
...
set design_name pwmbis_wrapper
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: pwmbis_0, and set properties
  set pwmbis_0 [ create_bd_cell -type ip -vlnv rfx:rfx:pwmbis:1.0 pwmbis_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins pwmbis_0/s00_axi]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwmbis_0/clk] [get_bd_pins pwmbis_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pwmbis_0_led_o [get_bd_ports led_o] [get_bd_pins pwmbis_0/led_o]
  connect_bd_net -net pwmbis_0_pwm_n_out [get_bd_ports pwm_n_out] [get_bd_pins pwmbis_0/pwm_n_out]
  connect_bd_net -net pwmbis_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins pwmbis_0/pwm_out]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwmbis_0/reset_n] [get_bd_pins pwmbis_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwmbis_0/s00_axi/reg0] SEG_pwmbis_0_reg0
