...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_test1_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper"
 file copy -force "$project_env(dir_src)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/pwmbis_wrapper.bd" \
    "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/pwmbis_wrapper.bd"
 file mkdir "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/hdl"
 file copy -force "$project_env(dir_src)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/hdl/pwmbis_wrapper_wrapper.v" \
    "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/hdl/pwmbis_wrapper_wrapper.v"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/pwmbis_wrapper.bd]"\
  "[file normalize $project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/hdl/pwmbis_wrapper_wrapper.v]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for sources_1
 # Properties for pwmbis_wrapper.bd
  set file "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/pwmbis_wrapper.bd"
 ...
 # 
 # Properties for pwmbis_wrapper_wrapper.v
  set file "$project_env(dir_prj)/rfx_test1_0.1.srcs/sources_1/bd/pwmbis_wrapper/hdl/pwmbis_wrapper_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
