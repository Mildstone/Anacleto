...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_pwmbis_1.0  "$make_env(builddir)/edit/vivado"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 set files [list \
  "[file normalize $make_env(srcdir)/../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/rfx_pwmgen_v1_0_S00_AXI.vhd]"\
  "[file normalize $make_env(srcdir)/../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/pwm.vhd]"\
  "[file normalize $make_env(srcdir)/../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/rfx_pwmgen_v1_0.vhd]"\
  "[file normalize $make_env(srcdir)/../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/component.xml]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # Properties for rfx_pwmgen_v1_0_S00_AXI.vhd
  set file "$project_env(dir_src)/../../../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/rfx_pwmgen_v1_0_S00_AXI.vhd"
 ...
 # Properties for pwm.vhd
  set file "$project_env(dir_src)/../../../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/pwm.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # Properties for rfx_pwmgen_v1_0.vhd
  set file "$project_env(dir_src)/../../../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/src/rfx_pwmgen_v1_0.vhd"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
  set_property -quiet "file_type" "VHDL" $file_obj
  set_property -quiet "is_enabled" "1" $file_obj
 ...
 # Properties for component.xml
  set file "$project_env(dir_src)/../../../../build/projects/test1/ip/vivado/rfx_pwmbis_1.0/component.xml"
  set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
