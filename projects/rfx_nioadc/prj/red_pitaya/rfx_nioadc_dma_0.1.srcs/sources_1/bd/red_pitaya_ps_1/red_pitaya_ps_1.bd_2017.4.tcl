...
proc create_root_design { parentCell } {
  ...
  set decimator [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_cfg_register:1.0 decimator ]
  set_property -dict [ list \
 ...
 ] [get_bd_intf_pins /decimator/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_packetizer_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins axis_packetizer_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_red_pitaya_adc_0_M_AXIS [get_bd_intf_pins axis_red_pitaya_adc_0/M_AXIS] [get_bd_intf_pins trarec_0/s_axis]
  ...
  connect_bd_intf_net -intf_net red_pitaya_ps_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins red_pitaya_ps_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net red_pitaya_ps_axi_periph_M01_AXI [get_bd_intf_pins decimator/S_AXI] [get_bd_intf_pins red_pitaya_ps_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net trarec_0_m_axis [get_bd_intf_pins axis_decimator_0/S_AXIS] [get_bd_intf_pins trarec_0/m_axis]
  ...
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins red_pitaya_ps/IRQ_F2P]
  ...
  connect_bd_net -net decimator_cfg_data [get_bd_pins axis_decimator_0/cfg_data] [get_bd_pins decimator/cfg_data]
  connect_bd_net -net packetizer_cfg_data [get_bd_pins axis_packetizer_0/cfg_data] [get_bd_pins packetizer/cfg_data]
  connect_bd_net -net red_pitaya_ps_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_decimator_0/aclk] [get_bd_pins axis_packetizer_0/aclk] [get_bd_pins axis_red_pitaya_adc_0/aclk] [get_bd_pins decimator/aclk] [get_bd_pins packetizer/aclk] [get_bd_pins red_pitaya_ps/FCLK_CLK0] [get_bd_pins red_pitaya_ps/M_AXI_GP0_ACLK] [get_bd_pins red_pitaya_ps/S_AXI_HP0_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/ACLK] [get_bd_pins red_pitaya_ps_axi_periph/M00_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/M01_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/M02_ACLK] [get_bd_pins red_pitaya_ps_axi_periph/S00_ACLK] [get_bd_pins rst_red_pitaya_ps_125M/slowest_sync_clk] [get_bd_pins trarec_0/aclk]
  ...
  connect_bd_net -net rst_red_pitaya_ps_125M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_decimator_0/aresetn] [get_bd_pins axis_packetizer_0/aresetn] [get_bd_pins decimator/aresetn] [get_bd_pins packetizer/aresetn] [get_bd_pins red_pitaya_ps_axi_periph/M00_ARESETN] [get_bd_pins red_pitaya_ps_axi_periph/M01_ARESETN] [get_bd_pins red_pitaya_ps_axi_periph/M02_ARESETN] [get_bd_pins red_pitaya_ps_axi_periph/S00_ARESETN] [get_bd_pins rst_red_pitaya_ps_125M/peripheral_aresetn] [get_bd_pins trarec_0/aresetn]
  ...
  connect_bd_net -net trarec_0_cbuf_rsta [get_bd_pins blk_mem_gen_0/rsta] [get_bd_pins trarec_0/cbuf_rsta]
  connect_bd_net -net trarec_0_cbuf_rstb [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins trarec_0/cbuf_rstb]
  ...
  connect_bd_net -net trigger_in_0_1 [get_bd_ports trigger_in] [get_bd_pins trarec_0/trigger_in]
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces red_pitaya_ps/Data] [get_bd_addr_segs packetizer/s_axi/reg0] SEG_axi_cfg_register_0_reg0
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x60000000 [get_bd_addr_spaces red_pitaya_ps/Data] [get_bd_addr_segs decimator/s_axi/reg0] SEG_decimator_reg0
