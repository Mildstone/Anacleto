...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file copy -force "$project_env(dir_src)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v" \
    "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
 set files [list \
  ...
  "[file normalize $project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v]"\
 ]
 ...
 # Properties for red_pitaya_ps_1_wrapper.v
  set file "$project_env(dir_prj)/rfx_nioadc_dma_0.1.srcs/sources_1/bd/red_pitaya_ps_1/hdl/red_pitaya_ps_1_wrapper.v"
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
