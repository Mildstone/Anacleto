...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "blink_bit" -parent ${Page_0}
...
proc update_PARAM_VALUE.blink_bit { PARAM_VALUE.blink_bit } {
	# Procedure called to update blink_bit when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.blink_bit { PARAM_VALUE.blink_bit } {
	# Procedure called to validate blink_bit
	return true
}
...
proc update_MODELPARAM_VALUE.blink_bit { MODELPARAM_VALUE.blink_bit PARAM_VALUE.blink_bit } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.blink_bit}] ${MODELPARAM_VALUE.blink_bit}
}
