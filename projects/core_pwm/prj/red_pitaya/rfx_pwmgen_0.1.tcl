...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 create_project rfx_pwmgen_0.1  "$make_env(builddir)/edit/red_pitaya"  -part xc7z010clg400-1
...
## ////////////////////////////////////////////////////////////////////////// ##
 ...
 file mkdir "$project_env(dir_prj)/rfx_pwmgen_0.1.srcs/sources_1/bd/design_1"
 file copy -force "$project_env(dir_src)/rfx_pwmgen_0.1.srcs/sources_1/bd/design_1/design_1.bd" \
    "$project_env(dir_prj)/rfx_pwmgen_0.1.srcs/sources_1/bd/design_1/design_1.bd"
 set files [list \
  "[file normalize $project_env(dir_prj)/rfx_pwmgen_0.1.srcs/sources_1/bd/design_1/design_1.bd]"\
 ]
 add_files -norecurse -fileset $obj $files
 # 
 # No properties for sources_1
 # Properties for design_1.bd
  set file "$project_env(dir_prj)/rfx_pwmgen_0.1.srcs/sources_1/bd/design_1/design_1.bd"
